...
/**
 * @basedOn
 *          https://github.com/carin-alliance/cpcds-server-ri/blob/patient-access/src/main/java/ca/uhn/fhir/jpa/starter/authorization/OauthEndpointController.java
 */
@RestController
public class OauthEndpointController {
  ...
  public ResponseEntity<String> postAccessToken(HttpServletRequest request,
  ...
  public ResponseEntity<String> postRefreshToken(HttpServletRequest request,
      @RequestParam(name = "grant_type") String grantType,
