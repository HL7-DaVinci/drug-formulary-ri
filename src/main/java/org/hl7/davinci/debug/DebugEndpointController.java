...
import org.hl7.davinci.authorization.Client;
import org.hl7.davinci.authorization.OauthEndpointController;
import org.hl7.davinci.authorization.Database.Table;

/**
 * @copied from
 *         https://github.com/carin-alliance/cpcds-server-ri/blob/patient-access/src/main/java/ca/uhn/fhir/jpa/starter/debug/DebugEndpointController.java
 */
@RestController
public class DebugEndpointController {
  ...
  public ResponseEntity<String> updateClient(HttpServletRequest request, HttpEntity<String> entity,
